...
class YOLODetectionNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter(
            'model_path',
            '/home/gr/drone_ws/src/yolo_detection_node/models/best.pt',
        )
        ...
        # QoS para imagenes de sensores: best-effort, buffer minimo
    ...
    def _image_callback(self, msg: Image) -> None:
        ...
        Args:
            msg: Imagen raw de la camara termica en encoding bgr8.
        """
        ...
        try:
            ...
            if results and results[0].boxes is not None:
                ...
                for i, box in enumerate(boxes):
                    # Usar track ID si el tracker lo asigno; si no, usar indice
            ...
            labeled_msg = self.bridge.cv2_to_imgmsg(labeled_frame, encoding='bgr8')
