...
# Video por defecto incluido en el proyecto
_DEFAULT_VIDEO = (
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description=(
                ...
                'Evita lag acumulado cuando la inferencia es mas lenta que el publish_rate. '
                'A 30 fps un frame dura ~33 ms; 100 ms equivale a ~3 frames de tolerancia.'
            ),
        ),
