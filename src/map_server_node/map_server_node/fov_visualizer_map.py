...
Nota: esta herramienta duplica la funcionalidad de
drone_tracker_utils/fov_visualizer.py. Se mantiene aqui por compatibilidad,
pero se recomienda usar la version en drone_tracker_utils directamente.

Uso:
    python3 fov_visualizer_map.py [ruta_al_archivo.SRT]
"""
...
class FOVMapVisualizer:
    ...
    def _print_help(self) -> None:
        """Muestra la ayuda del visualizador."""
        print(
            "\n"
            "AYUDA\n"
            "-----\n"
            ...
            "  j  Saltar a un frame especifico\n"
            ...
            "  Lineas punteadas Conexion del dron a cada esquina\n"
            "\n"
            "Que buscar:\n"
            "  OK   FOV es un rectangulo logico\n"
            "  OK   Rota correctamente con el yaw\n"
...
def main() -> None:
    ...
    if len(sys.argv) > 1:
        ...
        srt_path = (
            Path.home()
            / 'Documents/drone-detection-project/data/raw/thermal_videos'
            / 'DJI_20260210161918_0002_T.SRT'
        )
